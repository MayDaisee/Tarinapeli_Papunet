    ...
    public void Ranta()
    {
        ...
        for (int i = 0; i < choices.Count; i++)
        {
            ...
            resultTXT.text =
                ...
                "Sen jälkeen pakkaan reppuni.\nTarvitsen mukaani ainakin uimapuvun,\n" + choices[2] + " ja välipalaa.\n" +
                ...
                "Saavumme rannalle. Huomaamme heti,\nettä siellä on paljon " + choices[6] + ".\n" +
